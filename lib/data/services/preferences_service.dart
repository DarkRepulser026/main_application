...
Map<String, List<String>> settingSwitches = {
  ...
  'Layout' : ["sunstatus,rain indicator,hourly,alerts,daily,air quality"],
};
...
class SettingsProvider with ChangeNotifier {
  ...
  List<String> _layout = ["sunstatus", "rain indicator" ,"hourly", "alerts" ,"daily", "air quality"];
  ...
  void _load() {
    ...
    _layout = PreferenceUtils.getStringList("Layout order", ["sunstatus", "rain indicator" ,"hourly", "alerts" ,"daily", "air quality"]);
